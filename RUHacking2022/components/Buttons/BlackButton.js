...
const styles = StyleSheet.create({
  bigButton: {display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", padding: "16px 4px", gap: 12, position: "absolute", width: 328, height: 64, backgroundColor: "#14142B", borderRadius: 12},
  bigText: {height: 32, fontFamily: "'Poppins'", fontStyle: "normal", fontWeight: "bold", fontSize: 18, lineHeight: 32, display: "flex", alignItems: "center", textAlign: "center", letterSpacing: 0.75, color: "#FCFCFC", flex: "none", order: 0, flexGrow: 0},
